...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "PictureBookV7" /productName "PictureBookV7" > NUL
...
COPY /Y "PictureBookV7.msha" HelpContentSetup.msha
